...
extern "C" {
JNIEXPORT jlong JNICALL Java_com_example_spherik_myapplication_NativeLib_init(JNIEnv * env, jobject obj,  jint width, jint height);
JNIEXPORT void JNICALL Java_com_example_spherik_myapplication_NativeLib_deinit(JNIEnv * env, jobject obj);
JNIEXPORT void JNICALL Java_com_example_spherik_myapplication_NativeLib_render(JNIEnv * env, jobject obj, jlong renWinP);
JNIEXPORT void JNICALL Java_com_example_spherik_myapplication_NativeLib_onKeyEvent(JNIEnv * env, jobject obj, jlong udp,
                                                                      jboolean down, jint keyCode, jint metaState, jint repeatCount
);
JNIEXPORT void JNICALL Java_com_example_spherik_myapplication_NativeLib_onMotionEvent(JNIEnv * env, jobject obj, jlong udp,
                                                                         jint action,
                                                                         jint eventPointer,
                                                                         jint numPtrs,
 ...
 :m_interactor(vtkSmartPointer<vtkAndroidRenderWindowInteractor>::New())
{
  ...
  initializeTexture();
    ...
    m_renderer->AddActor(spikeActor.Get());
